...
public class CategoryHomeAdapter extends RecyclerView.Adapter<CategoryHomeAdapter.ItemRowHolder> {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_cat_home_item_theme2, parent, false);
    ...
    public void onBindViewHolder(ItemRowHolder holder, final int position) {
        ...
        //Picasso.with(mContext).load("file:///android_asset/image/" + itemCategory.getCategoryImage()).into(holder.image_cat);
