...
public class CouponListAdapter extends RecyclerView.Adapter<CouponListAdapter.ItemRowHolder> {

    private ArrayList<ItemCoupon> dataList;
    private Context mContext;

    public CouponListAdapter(Context context, ArrayList<ItemCoupon> dataList) {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_coupon_list_item, parent, false);
    ...
    public void onBindViewHolder(ItemRowHolder holder, final int position) {
        ...
        holder.lyt_parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent_list_coupon = new Intent(mContext, com.app.theme2.ActivityCouponDetail.class);
