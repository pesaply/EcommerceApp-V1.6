...
public class OrderProcessAdapter extends RecyclerView.Adapter<OrderProcessAdapter.ItemRowHolder> {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_order_process__item_theme2, parent, false);
    ...
    private void showRateDialog() {
        ...
        dialog.setContentView(R.layout.rating_dialgo_theme2);
