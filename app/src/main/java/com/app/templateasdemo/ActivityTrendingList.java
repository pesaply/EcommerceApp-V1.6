...
public class ActivityTrendingList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.trending_screen));
        ...
        recycler_cat_list.setLayoutManager(new GridLayoutManager(ActivityTrendingList.this, 3));
        ItemOffsetDecoration itemDecoration = new ItemOffsetDecoration(ActivityTrendingList.this, R.dimen.item_offset);
        ...
        ImgGrid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                recycler_cat_list.setLayoutManager(new GridLayoutManager(ActivityTrendingList.this, 3));
                adapter_cat_list = new LatestListAdapter(ActivityTrendingList.this, array_cat_list);
        ...
        ImgList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                recycler_cat_list.setLayoutManager(new GridLayoutManager(ActivityTrendingList.this, 1));
                adapter_cat_list_listview = new CategoryListViewAdapter(ActivityTrendingList.this, array_cat_list);
    ...
    private void showFilterDialog() {
        dialog = new Dialog(ActivityTrendingList.this, R.style.Theme_AppCompat_Translucent);
        ...
        recyclerView_color.setLayoutManager(new GridLayoutManager(ActivityTrendingList.this, 6));
        ItemOffsetDecoration itemDecoration = new ItemOffsetDecoration(ActivityTrendingList.this, R.dimen.item_offset);
        ...
        recyclerView_size.setLayoutManager(new GridLayoutManager(ActivityTrendingList.this, 6));
    ...
    private void prepareSizeData() {
        ...
        adapter_size = new SelectSizeAdapter(ActivityTrendingList.this, array_size);
