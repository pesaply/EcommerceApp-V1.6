...
public class SliderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (myApplication.getTheme2()) {
            ...
            setContentView(R.layout.activity_slider_theme2);
        }
        ...
        if (myApplication.getTheme2()) {
            layouts = new int[]{
                    R.layout.activity_slide1_theme2,
                    R.layout.activity_slide2_theme2,
                    R.layout.activity_slide3_theme2};
        }
    ...
    private void launchHomeScreen() {
        ...
        if (myApplication.getTheme2()) {
            prefManager.setFirstTimeLaunch(true);
            startActivity(new Intent(SliderActivity.this, com.app.theme2.Splash_Activity.class));
            finish();
        }
