...
import com.app.templateasdemo.ActivityCategoryList;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ItemRowHolder> {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_cat__item, parent, false);
    ...
    public void onBindViewHolder(ItemRowHolder holder, final int position) {
        ...
        Picasso.get().load("http://162.214.67.53:8000/categoria/obtenerImagenCategoria/"+itemCategory.getCategoryImageBanner()).into(holder.image_cat);
