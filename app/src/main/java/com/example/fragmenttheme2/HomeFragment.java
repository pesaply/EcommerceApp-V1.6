...
import com.app.adaptertheme2.CategoryHomeAdapter;
import com.app.adaptertheme2.CouponHomeAdapter;
import com.app.adaptertheme2.LatestListAdapter;
import com.app.templateasdemo.R;
import com.app.theme2.ActivityCategory;
import com.app.theme2.ActivityCouponList;
import com.app.theme2.ActivityProductDetail;
import com.app.theme2.ActivityTab;
import com.app.theme2.ActivityTrendingList;
...
public class HomeFragment extends Fragment {
    ...
    LatestListAdapter adapter_trending;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_home_theme2, container, false);
        ...
        view_all_latest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_latest=new Intent(getActivity(), ActivityTab.class);
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            View imageLayout = inflater.inflate(R.layout.row_home_slider_item_theme2, container, false);
    ...
    public void setAdapterHomeTrending() {
        ...
        adapter_trending = new LatestListAdapter(getActivity(), array_trending);
