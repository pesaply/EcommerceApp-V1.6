...
public class CrystalRangeSeekbar extends View {
    ...
    private double normalizedMaxValue = 1000d;
    ...
    protected float getMaxValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.CrystalRangeSeekbar_max_value, 10000f);
    }
    ...
    protected int getBarGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_bar_gradient_end, Color.parseColor("#6DD042"));
    }
    ...
    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_bar_highlight_color, Color.parseColor("#6DD042"));
    }

    protected int getBarHighlightGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_bar_highlight_gradient_start, Color.parseColor("#6DD042"));
    }

    protected int getBarHighlightGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_bar_highlight_gradient_end, Color.parseColor("#6DD042"));
    }

    protected int getLeftThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_left_thumb_color, Color.parseColor("#6DD042"));
    }

    protected int getRightThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_right_thumb_color, Color.parseColor("#6DD042"));
    }

    protected int getLeftThumbColorPressed(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_left_thumb_color_pressed, Color.parseColor("#6DD042"));
    }

    protected int getRightThumbColorPressed(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_right_thumb_color_pressed, Color.parseColor("#6DD042"));
    }
    ...
    private void setNormalizedMinValue(double value) {
        normalizedMinValue = Math.max(0d, Math.min(1000d, Math.min(value, normalizedMaxValue)));
    ...
    private void setNormalizedMaxValue(double value) {
        normalizedMaxValue = Math.max(0d, Math.min(1000d, Math.max(value, normalizedMinValue)));
        if(fixGap != NO_FIXED_GAP && fixGap > 0){
            addFixGap(false);
        }
        else{
    ...
    private void addMinGap(){
        if((normalizedMinValue + gap) > normalizedMaxValue){
            ...
            normalizedMaxValue = Math.max(0d, Math.min(1000d, Math.max(g, normalizedMinValue)));
    ...
    private void addMaxGap(){
        if((normalizedMaxValue - gap) < normalizedMinValue){
            ...
            normalizedMinValue = Math.max(0d, Math.min(1000d, Math.min(g, normalizedMaxValue)));
